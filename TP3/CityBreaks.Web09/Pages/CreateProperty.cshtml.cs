...
namespace CityBreaks.Web08.Pages
{
    public class CreatePropertyModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            //// Popula a propriedade City manualmente antes da validação do ModelState
            //Property.City = await _context.Cities.FindAsync(Property.CityId);

            //Console.WriteLine($"City: {Property.City}");

            //// Agora, manualmente chama validação do modelo
